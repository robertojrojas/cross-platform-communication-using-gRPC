...
func (*FileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e93a59a553a5ae7c, []int{0}
}
...
func (*FileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e93a59a553a5ae7c, []int{1}
}
...
func init() { proto.RegisterFile("file/server.proto", fileDescriptor_e93a59a553a5ae7c) }

var fileDescriptor_e93a59a553a5ae7c = []byte{
...
func (c *fileTransferServiceClient) Upload(ctx context.Context, opts ...grpc.CallOption) (FileTransferService_UploadClient, error) {
	stream, err := c.cc.NewStream(ctx, &_FileTransferService_serviceDesc.Streams[0], "/FileTransferService/Upload", opts...)
	if err != nil {
		return nil, err
	}
